...
// 暂时保留默认常量，seeder 仍会引用
export const DEFAULT_ZAIWEN_CHAT_MODEL = 'GLM-5';

/**
 * 在问模型种子（已暂时注释）
 * 当前阶段只保留 Grok2API 供应商下的 grok-4.5 与 grok-build-0.1
 * 全部注释不影响类型导出与下游引用
 */
...
//   { modelId: 'Gemini-3.0-Flash', inputMultiplier: 0.125, outputMultiplier: 0.5 },
//   { modelId: 'Gemini-3.1-Flash-Lite', inputMultiplier: 0.085, outputMultiplier: 0.34 },
//   { modelId: 'Gemini-3.1-Pro', inputMultiplier: 0.5, outputMultiplier: 2 },
//   { modelId: 'Grok-4-Fast-Reasoning', inputMultiplier: 0.035, outputMultiplier: 0.14 },
//   { modelId: 'Grok-4.1-Fast-Non-Reasoning', inputMultiplier: 0.15, outputMultiplier: 0.6 },
//   { modelId: 'Grok-4.1-Fast-Reasoning', inputMultiplier: 0.15, outputMultiplier: 0.6 },
//   { modelId: 'Grok-4.20-Multi-Agent', inputMultiplier: 3, outputMultiplier: 12 },
//   { modelId: 'Kimi-K2-Thinking', inputMultiplier: 0.465, outputMultiplier: 1.86 },
//   { modelId: 'Nano-Banana-Pro', inputMultiplier: 61111, outputMultiplier: 244444 },
//   { modelId: 'Nano-Banana-Pro-2k', inputMultiplier: 121111, outputMultiplier: 484444 },
//   { modelId: 'Nano-Banana-Pro-4k', inputMultiplier: 241111, outputMultiplier: 964444 },
//   { modelId: 'Qwen-3-Max', inputMultiplier: 0.73, outputMultiplier: 2.92 },
//   { modelId: 'claude-haiku-4.5', inputMultiplier: 0.21, outputMultiplier: 0.84 },
//   { modelId: 'claude-opus-4-6', inputMultiplier: 2.08, outputMultiplier: 8.32 },
//   { modelId: 'claude-sonnet-4-reasoner', inputMultiplier: 1.25, outputMultiplier: 5 },
//   { modelId: 'deepseek-reasoner', inputMultiplier: 0.465, outputMultiplier: 1.86 },
//   { modelId: 'deepseekv3', inputMultiplier: 0.47, outputMultiplier: 1.88 },
//   { modelId: 'gemini_2_5_flash', inputMultiplier: 0.105, outputMultiplier: 0.42 },
...
//   { modelId: 'gpt-5.2-chat-latest', inputMultiplier: 1.75, outputMultiplier: 7 },
